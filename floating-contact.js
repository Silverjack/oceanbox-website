(() => {
  ...
  const whatsappText = encodeURIComponent("Hi, I would like to discuss container availability.");
  ...
  const createMenu = (root) => {
    ...
    root.innerHTML = `
      <a class="floating-contact-menu__item floating-contact-menu__item--email" href="mailto:${emailAddress}" data-tip="Send Email" aria-label="Send Email">
      ...
      <a class="floating-contact-menu__item floating-contact-menu__item--whatsapp" href="https://wa.me/${whatsappNumber}?text=${whatsappText}" target="_blank" rel="noopener noreferrer" data-tip="Chat on WhatsApp" aria-label="Chat on WhatsApp">
        <svg viewBox="0 0 24 24" role="img" aria-hidden="true">
